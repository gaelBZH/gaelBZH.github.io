...
const clamp = (val) => Math.min(Math.max(val, 0), 100);
        ...
        function updateUI()
        {
            ...
            barre.textContent = Math.round(pourcent*100)/100 + "%";
            ...
            else if (pourcent >= 90)  couleur = "#008000"; // green
            ...
            else if (pourcent >= 50)  couleur = "#ffff00"; // yellow
            else if (pourcent >= 42)  couleur = "#FFD700"
            else if (pourcent >= 38)  couleur = "#ffbf00";
            else if (pourcent >= 35)  couleur = "#ffa500"; // orange
            else if (pourcent >= 30)  couleur = "#ff8132";
            else if (pourcent >= 25)  couleur = "#FF6347"
            else if (pourcent >= 20)  couleur = "#ff5331";
            else if (pourcent >= 15)  couleur = "#ff4500"; // orangered
            else if (pourcent >= 10)  couleur = "#ff0000"; // red
            else if (pourcent >= 7)   couleur = "#B22222"
            else if (pourcent >= 5)   couleur = "#8b0000"; // darkred
